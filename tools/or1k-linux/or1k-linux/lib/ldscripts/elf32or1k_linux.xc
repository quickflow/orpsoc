...
OUTPUT_ARCH(or1k)
ENTRY(_start)
SEARCH_DIR("/opt/crossbuild/output/or1k-linux/or1k-linux/lib");
SECTIONS
{
  /* Read-only sections, merged into text segment: */
  PROVIDE (__executable_start = SEGMENT_START("text-segment", 0x00002000));
  . = SEGMENT_START("text-segment", 0x00002000) + SIZEOF_HEADERS;
