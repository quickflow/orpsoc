...
integer delay;			// waits for Chip Erase to complete
   ...
   // Changed by Julius 280508 - iverilog error was: AT26DFxxx.v:2244: sorry: tperiod is a real in a net/wire context.
//real tperiod;			// time period - on period
   time tperiod;			// time period - on period
//real tperiod1;			// time period - off period
   time tperiod1;			// time period - off period
