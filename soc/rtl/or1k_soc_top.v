...
`endif
   ...
   d2d_wishbone_dma_top d2d
     (
      .wb_clk       ( clk_cpu_25 ),
      .wb_rst_n     ( !wb_rst_pad_i ),
      .m_adr_o      ( wbm_d2d_adr_o ),
      .m_dat_o      ( wbm_d2d_dat_o ),
      .m_dat_i      ( wbm_d2d_dat_i ),
      .m_we_o       ( wbm_d2d_we_o ),
      .m_stb_o      ( wbm_d2d_stb_o ),
      .m_cyc_o      ( wbm_d2d_cyc_o ),
      .m_ack_i      ( wbm_d2d_ack_i ),
      .s_adr_i      ( wbs_d2d_adr_i ),
      .s_dat_i      ( wbs_d2d_dat_i ),
      .s_dat_o      ( wbs_d2d_dat_o ),
      .s_we_i       ( wbs_d2d_we_i ),
      .s_stb_i      ( wbs_d2d_stb_i ),
      .s_cyc_i      ( wbs_d2d_cyc_i ),
      .s_ack_o      ( wbs_d2d_ack_o ),
      .d2d_clk      ( d2d_clk ), 
      .d2d_rst_n    ( d2d_rst_n ),
